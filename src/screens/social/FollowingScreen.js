  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.subtitle}>Daftar diikuti akan ditampilkan di sini</Text>
        
        {/* TEMPORARY: Tap untuk lihat profil yang diikuti */}
        <View style={styles.navSection}>
          <Text style={styles.navLabel}>Sementara - Testing Navigation</Text>
          <Button title="Lihat Profil" onPress={() => navigation.navigate('UserProfile', { userId: 'following1' })} />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
